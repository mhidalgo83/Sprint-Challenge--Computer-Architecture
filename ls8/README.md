...
* Write a short 3-10-word description of what each file does.
    cpu.py is a class that will contain the functionality for the pc emulator. The ls8.py file will contain the commands for the emulator.
* Note what has been implemented, and what hasn't.
    Need to define properties of the cpu class. 
    Need to implement RAM functions
    Implement core of CPU functions
